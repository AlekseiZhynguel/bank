...
public class Account extends AggregateRoot {
    ...
    public AccountPrimitives toPrimitives() {
        return new AccountPrimitives(id.value(), name().value(), email().value(), phone().value(), dni().value());
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, account.id) && Objects.equals(name, account.name) && Objects.equals(email, account.email) && Objects.equals(phone, account.phone) && Objects.equals(dni, account.dni);
    }
